<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EOExport.aspx.cs" Inherits="MUREOUI.Common.EOExport" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>EOExport</title>
...
<body onfocus="undoHourglass();" onbeforeunload="doHourglass();" onunload="doHourglass();"
    onblur="DoHourglass();" ms_positioning="GridLayout">
    <form id="Form1" method="post" runat="server">
    <table id="maintbl" cellspacing="0" cellpadding="0" width="336">
        <tr>
            <td>
                                            ...
                                            <tr valign="middle" bgcolor="#ffffcc">
                                                <td style="height: 43px" align="center" colspan="5">
                                                    ...
                                                    <div class="FormHeader">
                                                        Open Data Export</div>
                                                </td>
                                            </tr>
                                            <tr id="hide" height="10" runat="server">
                                                <td class="DataGridBorderColor" align="left">
                                                    <p class="AttachmentMsg" align="justify">
                                                        The spreadsheet below is a template for exporting MUR data.Follow the directions
                                                        in the Excel file to update it with information from the MUR database. Please click
                                                        on the image below&nbsp;to start the data export.</p>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td align="left">
                                                    <asp:ImageButton ID="ImgExport" runat="server" 
                                                        ImageUrl="../Images/excelicon.gif" onclick="ImgExport_Click">
                                                    </asp:ImageButton>
                                                </td>
                                            </tr>
                                        </table>
                                        GetEODataTemplateRev1.xls
                                    </td>
                                </tr>
                            </table>
                        </td>
