...
{
    public partial class ApprovedEOs : System.Web.UI.Page
    {
        #region "Member Variables"

        DataSet dsApprovedEO;
        string strScript;
        ...
        protected void Page_Load(object sender, System.EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                //TotalHeaderLabelsVisiblity(False)        
        ...
        public void TotalHeaderLabelsVisiblity(bool optVisible)
        {
            lblEOTypeVal.Visible = optVisible;
            lblPlantVal.Visible = optVisible;
            lblPlantlb.Visible = optVisible;
        ...
        protected void imgEOMode2_Command(object sender, CommandEventArgs e)
        {
            try
            {
                ...
                for (int rowCount = rowno + 1; rowCount <= dgdAppEOTree.VisibleRowCount - 1; rowCount++)
                {
        ...
        protected void imgEOMode1_Command(object sender, CommandEventArgs e)
        {
            ...
            Label lblPlantName = (Label)dgdAppEOTree.FindRowCellTemplateControl(rowno, (GridViewDataColumn)dgdPrelimSelectedEO.Columns["Plant"], "lblPlantName");
        ...
        protected void imgPlant2_Command(object sender, CommandEventArgs e)
        {
            ...
            for (int rowCount = rowno + 1; rowCount <= dgdAppEOTree.VisibleRowCount - 1; rowCount++)
            {
                ...
                //imgEOMode1 = (ImageButton)dgdAppEOTree.Items(rowCount).FindControl("imgEOMode1");
                //ImageButton imgEOMode2 = default(ImageButton);
                //imgEOMode2 = (ImageButton)dgdAppEOTree.Items(rowCount).FindControl("imgEOMode2");
                if (lblPlantName != null)
                {
        ...
        protected void imgPlant1_Command(object sender, CommandEventArgs e)
        {
            try
            {
                ...
                for (int rowCount = rowno + 1; rowCount <= dgdAppEOTree.VisibleRowCount - 1; rowCount++)
                {
                    ...
                    Label lblPlantName = (Label)dgdAppEOTree.FindRowCellTemplateControl(rowCount, (GridViewDataColumn)dgdAppEOTree.Columns["Plant"], "lblPlantName");
                    Label lblEOMode = (Label)dgdAppEOTree.FindRowCellTemplateControl(rowCount, (GridViewDataColumn)dgdAppEOTree.Columns["EO Type"], "lblEOMode");


                    ImageButton imgEOMode1 = (ImageButton)dgdAppEOTree.FindRowCellTemplateControl(rowCount, (GridViewDataColumn)dgdAppEOTree.Columns["EO Type"], "imgEOMode1");
                    ImageButton imgEOMode2 = (ImageButton)dgdAppEOTree.FindRowCellTemplateControl(rowCount, (GridViewDataColumn)dgdAppEOTree.Columns["EO Type"], "imgEOMode2");
        ...
        protected void dgdPrelimSelectedEO_HtmlRowPrepared(object sender, ASPxGridViewTableRowEventArgs e)
        {
            try
            {
                ...
                {
                    Label lblCurrentStage = (Label)dgdAppEOTree.FindRowCellTemplateControl(e.VisibleIndex, (GridViewDataColumn)dgdAppEOTree.Columns["Current Stage"], "lblCurrentStage");
                    Label lblStageStatus = (Label)dgdAppEOTree.FindRowCellTemplateControl(e.VisibleIndex, (GridViewDataColumn)dgdAppEOTree.Columns["Status"], "lblStageStatus");
        ...
        protected void dgdAppEOTree_HtmlRowPrepared(object sender, ASPxGridViewTableRowEventArgs e)
        {
            try
            {
                ASPxGridView gvDetailGridView = (ASPxGridView)sender;
                ...
                if (e.RowType == DevExpress.Web.ASPxGridView.GridViewRowType.Data)
                {
                    Label lblPlantName = (Label)dgdAppEOTree.FindRowCellTemplateControl(e.VisibleIndex, (GridViewDataColumn)dgdAppEOTree.Columns["Plant"], "lblPlantName");
                    Label lblPlantId = (Label)dgdAppEOTree.FindRowCellTemplateControl(e.VisibleIndex, (GridViewDataColumn)dgdAppEOTree.Columns["Plant"], "lblPlantId");
                    Label lblEOMode = (Label)dgdAppEOTree.FindRowCellTemplateControl(e.VisibleIndex, (GridViewDataColumn)dgdAppEOTree.Columns["EO Type"], "lblEOMode");
                    ImageButton imgEOMode1 = (ImageButton)dgdAppEOTree.FindRowCellTemplateControl(e.VisibleIndex, (GridViewDataColumn)dgdAppEOTree.Columns["EO Type"], "imgEOMode1");
                    ImageButton imgEOMode2 = (ImageButton)dgdAppEOTree.FindRowCellTemplateControl(e.VisibleIndex, (GridViewDataColumn)dgdAppEOTree.Columns["EO Type"], "imgEOMode2");
                    ImageButton imgPlant1 = (ImageButton)dgdAppEOTree.FindRowCellTemplateControl(e.VisibleIndex, (GridViewDataColumn)dgdAppEOTree.Columns["Plant"], "imgPlant1");
                    ImageButton imgPlant2 = (ImageButton)dgdAppEOTree.FindRowCellTemplateControl(e.VisibleIndex, (GridViewDataColumn)dgdAppEOTree.Columns["Plant"], "imgPlant2");
        ...
        protected void dgdPrelimSelectedEO_PageIndexChanged(object source, EventArgs e)
        {
            try
            {
                FillApprovedSelectedEOs(Convert.ToInt32(ViewState["Plant_ID"]));
            }
            catch (Exception exc)
            {
        ...
        protected void dgdAppEOTree_PageIndexChanged(object sender, EventArgs e)
        {
            try
            {
                FillApprovedEOs();
        ...
        protected void FillApprovedSelectedEOs(int intPlantID)
        {
            try
            {
                DataSet dsSelectApprovedEOs = new DataSet();

                ClsMyEOs objEOs = new ClsMyEOs();
                if (objEOs.GetApprovedSelectedEO(intPlantID, "Final", "", strUserName, ref dsSelectApprovedEOs))
                {

                    if (dsSelectApprovedEOs == null)
                    {
                        NoRecords();
                        dgdPrelimSelectedEO.DataSource = null;
                        dgdPrelimSelectedEO.Visible = false;
                    }
                    else if (dsSelectApprovedEOs.Tables.Count == 0)
                    {
                        NoRecords();
                        dgdPrelimSelectedEO.DataSource = null;
                        dgdPrelimSelectedEO.Visible = false;
                    }
                    else if (dsSelectApprovedEOs.Tables[0].Rows.Count == 0)
                    {
                        NoRecords();
                        dgdPrelimSelectedEO.DataSource = null;
                        dgdPrelimSelectedEO.Visible = false;
                    ...
                    else if (dsSelectApprovedEOs.Tables[0].Rows.Count > 0)
                    {
                        ...
                        dgdPrelimSelectedEO.DataSource = dsSelectApprovedEOs.Tables[0].DefaultView;
                        ...
                        //    string SortExp = null;
                        //    string strSort = null;
                        //    DataView dv = new DataView(dsSelectApprovedEOs.Tables[0]);
                        ...
                        dgdPrelimSelectedEO.Visible = true;
                        lblPlantVal.Text = Convert.ToString(dsSelectApprovedEOs.Tables[0].Rows[0][8]);
                        ...
                        for (int numRows = 0; numRows <= dgdPrelimSelectedEO.VisibleRowCount - 1; numRows++)
                        {
                            ...
                            //lblISApproved = (Label)dgdPrelimSelectedEO.Items(numRows).FindControl("lblISApprovar");
        ...
        public void EnableDisableLinksForRow(bool optBool, int numRows)
        {
            ...
            //lnkEONum = (LinkButton)dgdPrelimSelectedEO.Items(numRows).FindControl("hypEONumber");
            //lnkEONum.Enabled = optBool;
            //LinkButton lnkEOTitle = default(LinkButton);
            //lnkEOTitle = (LinkButton)dgdPrelimSelectedEO.Items(numRows).FindControl("hypEOTitle");
            //lnkEOTitle.Enabled = optBool;
            //LinkButton lnkEOModDate = default(LinkButton);
            //lnkEOModDate = (LinkButton)dgdPrelimSelectedEO.Items(numRows).FindControl("hypModifiedDate");
        ...
        //09/03/07                Md.Abdul allaam             1.0           created
        //***************************************************
        public void FillApprovedEOs()
        {
            try
            {
                dsApprovedEO = new DataSet();
                ...
                if (objAllEos.GetApprovedEO("Final", "", ref dsApprovedEO))
                {

                    if (dsApprovedEO == null)
                    {
                        NoRecords();
                    ...
                    else if (dsApprovedEO.Tables.Count == 0)
                    {
                        NoRecords();
                        tdDivider.Visible = false;
                        lblPlantlb.Visible = false;
                    ...
                    else if (dsApprovedEO.Tables[0].Rows.Count == 0)
                    {
                        NoRecords();
                        tdDivider.Visible = false;
                        lblPlantlb.Visible = false;
                    ...
                    else
                    {
                        ...
                        DataTable dtApprovedEos = new DataTable();

                        DataRow drApprovedEos = null;

                        dtApprovedEos.Columns.Add("Plant_ID");
                        dtApprovedEos.Columns.Add("Plant_Name");
                        dtApprovedEos.Columns.Add("EO_Mode");
                        ...
                        string strPlantName = Convert.ToString(dsApprovedEO.Tables[0].Rows[0]["Plant_Name"]);

                        string strPlantID = Convert.ToString(dsApprovedEO.Tables[0].Rows[0]["Plant_ID"]);
                        ...
                        for (int rowCount = 0; rowCount <= dsApprovedEO.Tables[0].Rows.Count - 1; rowCount++)
                        {
                            string strPlantName1 = Convert.ToString(dsApprovedEO.Tables[0].Rows[rowCount]["Plant_Name"]);
                            string strPlantID1 = Convert.ToString(dsApprovedEO.Tables[0].Rows[rowCount]["Plant_ID"]);
                        ...
                        {
                            drApprovedEos = dtApprovedEos.NewRow();

                            drApprovedEos["Plant_ID"] = arrayPlantID[rowPlantNameCount];
                            drApprovedEos["Plant_Name"] = arrayPlantName[rowPlantNameCount];
                            drApprovedEos["EO_Mode"] = "";

                            dtApprovedEos.Rows.Add(drApprovedEos);
                            ...
                            for (int rowEOModeCount = 0; rowEOModeCount <= dsApprovedEO.Tables[0].Rows.Count - 1; rowEOModeCount++)
                            {

                                if (Convert.ToString(arrayPlantName[rowPlantNameCount]) == Convert.ToString(dsApprovedEO.Tables[0].Rows[rowEOModeCount][1]))
                                {
                                    string strEOMode = Convert.ToString(dsApprovedEO.Tables[0].Rows[rowEOModeCount][2]);

                                    strPlanID = Convert.ToString(dsApprovedEO.Tables[0].Rows[rowEOModeCount][0]);
                            ...
                            {
                                drApprovedEos = dtApprovedEos.NewRow();
                                drApprovedEos["Plant_ID"] = strPlanID;
                                //arrayPlantID(rowEOMode1)
                                drApprovedEos["EO_Mode"] = arrayEOMode[rowEOMode1];
                                dtApprovedEos.Rows.Add(drApprovedEos);

                            }
                        }
                        DataColumn dc = new DataColumn("Index");
                        dtApprovedEos.Columns.Add(dc);
                        Int32 ind = 0;
                        foreach (DataRow dr in dtApprovedEos.Rows)
                        {

                            dr["Index"] = ind;
                            ind++;
                        }
                        dgdAppEOTree.DataSource = dtApprovedEos;
                        dgdAppEOTree.DataBind();
        ...
        //protected void dgdPrelimSelectedEO_ItemDataBound1(object sender, System.Web.UI.WebControls.DataGridItemEventArgs e)
        //{
        //    e.Item.Cells[3].HorizontalAlign = HorizontalAlign.Center;
        //    //// Added by Abdul on 15-Sept-08 for changing the status from Approved to Completed.
        //    if (Strings.UCase(e.Item.Cells[4].Text) == Strings.UCase("CloseOut") & Strings.UCase(e.Item.Cells[5].Text) == Strings.UCase("Approved"))
        //    {
        ...
        //  ************************************************
        //Developed by   :	Vertex Computer Systems, Inc.,
        //Name   	    :	dgdAppEOTree_ItemDataBound()
        //Written BY	    :	Md.Abdul Allaam
        //parameters     :	Built in
        ...
        //09/03/07                Md.Abdul allaam             1.0           created
        //***************************************************
        //protected void dgdAppEOTree_ItemDataBound(object sender, System.Web.UI.WebControls.DataGridItemEventArgs e)
        //{
        ...
        //protected void dgdAppEOTree_ItemCommand(object source, System.Web.UI.WebControls.DataGridCommandEventArgs e)
        //{
        ...
        //        for (int rowCount = rowno + 1; rowCount <= dgdAppEOTree.Items.Count - 1; rowCount++)
        //        {


        //            Label lblPlantName = (Label)dgdAppEOTree.Items(rowCount).FindControl("lblPlantName");
        //            Label lblEOMode = (Label)dgdAppEOTree.Items(rowCount).FindControl("lblEOMode");
        //            Label lblPlantId = (Label)dgdAppEOTree.Items(rowCount).FindControl("lblPlantID");
        ...
        //                if (!string.IsNullOrEmpty(lblEOMode.Text))
        //                {
        //                    dgdAppEOTree.Items(rowCount).Visible = true;
        //                    imgEOMode1.Visible = true;
        //                    imgEOMode2.Visible = false;
        //                    //lblBrandSegmentID.Visible = False
        //                }
        //                else
        //                {
        //                    dgdAppEOTree.Items(rowCount).Visible = false;
        //                }
        ...
        //        Label lblPlanID = (Label)e.Item.FindControl("lblPlantID");
        ...
        //        //hdID.Value = lblPlanID.Text + "," + lblOriginator.Text
        //        //Code added by Vijay
        //        ViewState["Plant_ID") = lblPlanID.Text;
        //        FillApprovedSelectedEOs(Convert.ToInt32(lblPlanID.Text));
        ...
        //        {
        //            int intEOID = Convert.ToInt32(dgdPrelimSelectedEO.DataKeys(e.Item.ItemIndex));
        ...
        //    }
        //}
        //protected void dgdPrelimSelectedEO_PageIndexChanged(object source, System.Web.UI.WebControls.DataGridPageChangedEventArgs e)
        //{
        //    dgdPrelimSelectedEO.CurrentPageIndex = e.NewPageIndex;
        //    FillApprovedSelectedEOs(intGlobalPlantId);
        //}
