<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ViewConcurrenceGroup.aspx.cs"
    Inherits="MUREOUI.Administration.ViewConcurrenceGroup" %>
...
<html>
<head>
    <title>ViewConcurrenceGroup</title>
                                    ...
                                    <table id="tbl2" width="100%">
                                        ...
                                        <tr>
                                            <td align="center" colspan="2">
                                                ...
                                                <asp:HiddenField ID="txthiddenConGrpID" runat="server" />
                                                <asp:HiddenField ID="txthiddenPurchaseContactId" runat="server" />
                                                <asp:ImageButton ID="imgSubmit" OnClick="imgSubmit_Click" runat="server" ImageUrl="../Images/edit.gif">
                                                </asp:ImageButton>&nbsp;
                                                <asp:ImageButton ID="imgCancel" runat="server" OnClick="imgCancel_Click" ImageUrl="../images/cancel.gif"
                                        ...
                                        <tr>
                                            <td valign="top">
                                                <table id="tbl3" height="3" width="100%" align="left" border="0">
                                                    ...
                                                    <tr>
                                                        <td class="FieldNames" valign="top" align="right">
                                                            Concurrence Group Names:&nbsp;&nbsp;
                                                        </td>
                                                        <td valign="top">
                                                            <asp:Label ID="lblConGrpNames" runat="server" Width="200"></asp:Label>
                                                        </td>
                                                    </tr>
                                                    <tr height="1">
                                                        <td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td valign="top">
                                                            <asp:Label ID="lblNameforGroup" runat="server" Width="200"></asp:Label>
                                                        </td>
                                                        <tr height="1">
                                                            <td>
                                                                &nbsp;
